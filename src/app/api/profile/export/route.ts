...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    user: {
      ...
      codingPlanDailyCostLimitCents: user.codingPlanDailyCostLimitCents,
      codingPlanExpiresAt: user.codingPlanExpiresAt?.toISOString() ?? null,
      codingPlanId: user.codingPlanId,
      codingPlanMonthlyCostLimitCents: user.codingPlanMonthlyCostLimitCents,
      codingPlanName: user.codingPlanName,
      codingPlanPersonalApiEnabled: user.codingPlanPersonalApiEnabled,
      codingPlanWeeklyCostLimitCents: user.codingPlanWeeklyCostLimitCents,
