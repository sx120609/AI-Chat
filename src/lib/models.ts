...
export const CHAT_MODELS: ChatModelConfig[] = [
  ...
  },
  {
    ...
    inputCentsPerMillionTokens: 56,
    cachedInputCentsPerMillionTokens: 5.6,
    outputCentsPerMillionTokens: 336,
    contextWindowTokens: DEFAULT_CONTEXT_WINDOW_LIMIT_TOKENS,
    maxContextWindowTokens: MAX_CONTEXT_WINDOW_LIMIT_TOKENS,
    contextNote: "Terra",
    source: "default",
  ...
  },
  {
    ...
    inputCentsPerMillionTokens: 5.6,
    cachedInputCentsPerMillionTokens: 0.56,
    outputCentsPerMillionTokens: 33.6,
    contextWindowTokens: DEFAULT_CONTEXT_WINDOW_LIMIT_TOKENS,
    maxContextWindowTokens: MAX_CONTEXT_WINDOW_LIMIT_TOKENS,
    contextNote: "Luna",
    source: "default",
