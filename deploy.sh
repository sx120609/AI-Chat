...
WEB_SEARCH_PROVIDER="${WEB_SEARCH_PROVIDER:-sub2api}"
WEB_SEARCH_MAX_RESULTS="${WEB_SEARCH_MAX_RESULTS:-5}"
BILLING_MULTIPLIER="${BILLING_MULTIPLIER:-1}"
BILLING_MULTIPLIER_STARTS_AT="${BILLING_MULTIPLIER_STARTS_AT:-}"
BILLING_MULTIPLIER_ENDS_AT="${BILLING_MULTIPLIER_ENDS_AT:-}"
USER_API_CONCURRENCY_LIMIT="${USER_API_CONCURRENCY_LIMIT:-0}"
...
EASYPAY_ENABLED="${EASYPAY_ENABLED:-false}"
EASYPAY_ALLOW_REFUND="${EASYPAY_ALLOW_REFUND:-false}"
EASYPAY_DISPLAY_MODE="${EASYPAY_DISPLAY_MODE:-qrcode}"
EASYPAY_METHODS_JSON="${EASYPAY_METHODS_JSON:-[\"alipay\",\"wxpay\"]}"
EASYPAY_BALANCE_CENTS_PER_YUAN="${EASYPAY_BALANCE_CENTS_PER_YUAN:-100}"
EASYPAY_PID="${EASYPAY_PID:-}"
EASYPAY_KEY="${EASYPAY_KEY:-}"
EASYPAY_API_BASE_URL="${EASYPAY_API_BASE_URL:-}"
EASYPAY_ALIPAY_CHANNEL_ID="${EASYPAY_ALIPAY_CHANNEL_ID:-}"
EASYPAY_WXPAY_CHANNEL_ID="${EASYPAY_WXPAY_CHANNEL_ID:-}"
...
EOF
    ...
    append_env_line_if_missing "EASYPAY_ENABLED" "${EASYPAY_ENABLED:-false}"
    append_env_line_if_missing "EASYPAY_ALLOW_REFUND" "${EASYPAY_ALLOW_REFUND:-false}"
    append_env_line_if_missing "EASYPAY_DISPLAY_MODE" "${EASYPAY_DISPLAY_MODE:-qrcode}"
    append_env_line_if_missing "EASYPAY_METHODS_JSON" "${EASYPAY_METHODS_JSON:-[\"alipay\",\"wxpay\"]}"
    append_env_line_if_missing "EASYPAY_BALANCE_CENTS_PER_YUAN" "${EASYPAY_BALANCE_CENTS_PER_YUAN:-100}"
    append_env_line_if_missing "EASYPAY_PID" "${EASYPAY_PID:-}"
    append_env_line_if_missing "EASYPAY_KEY" "${EASYPAY_KEY:-}"
    append_env_line_if_missing "EASYPAY_API_BASE_URL" "${EASYPAY_API_BASE_URL:-}"
    append_env_line_if_missing "EASYPAY_ALIPAY_CHANNEL_ID" "${EASYPAY_ALIPAY_CHANNEL_ID:-}"
    append_env_line_if_missing "EASYPAY_WXPAY_CHANNEL_ID" "${EASYPAY_WXPAY_CHANNEL_ID:-}"
