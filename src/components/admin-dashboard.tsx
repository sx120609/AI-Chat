...
export function AdminDashboard({ currentUser }: AdminDashboardProps) {
  ...
  const applySettings = useCallback((nextSettings: AiSettingsView) => {
    ...
    setSettingsForm({
      ...
      gpt54ProApiBaseUrl: nextSettings.gpt54ProApiBaseUrl,
      gpt54ProApiKey: "",
      gpt54ProOrgId: nextSettings.gpt54ProOrgId,
      ...
      visibleChatModelIds: nextSettings.visibleChatModelIds,
      ...
      webSearchCostCents: nextSettings.webSearchCostCents,
      billingMultiplier: nextSettings.billingMultiplier,
      billingMultiplierStartsAt: nextSettings.billingMultiplierStartsAt,
      billingMultiplierEndsAt: nextSettings.billingMultiplierEndsAt,
      userApiConcurrencyLimit: nextSettings.userApiConcurrencyLimit,
